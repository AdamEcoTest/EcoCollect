...
import org.eco.collect.android.openrosa.OpenRosaConstants;
...
import org.eco.collect.android.test.MockedServerTest;
...
import static org.eco.collect.android.test.TestUtils.assertMatches;
import static org.eco.collect.android.test.TestUtils.cleanUpTempFiles;
import static org.eco.collect.android.test.TestUtils.createTempFile;
import static org.eco.collect.android.test.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("org.eco.collect.android/.* Dalvik/.*", r.getHeader("User-Agent"));
