...
package org.eco.collect.android.activities;
...
import org.eco.collect.android.audio.AudioControllerView;
import org.eco.collect.android.dao.FormsDao;
import org.eco.collect.android.dao.helpers.ContentResolverHelper;
import org.eco.collect.android.dao.helpers.FormsDaoHelper;
import org.eco.collect.android.dao.helpers.InstancesDaoHelper;
import org.eco.collect.android.events.ReadPhoneStatePermissionRxEvent;
import org.eco.collect.android.events.RxEventBus;
import org.eco.collect.android.exception.JavaRosaException;
import org.eco.collect.android.external.ExternalDataManager;
import org.eco.collect.android.formentry.FormLoadingDialogFragment;
import org.eco.collect.android.formentry.FormSaveViewModel;
import org.eco.collect.android.formentry.ODKView;
import org.eco.collect.android.formentry.QuitFormDialog;
import org.eco.collect.android.formentry.SaveFormProgressDialogFragment;
import org.eco.collect.android.formentry.audit.AuditEvent;
import org.eco.collect.android.formentry.audit.ChangesReasonPromptDialogFragment;
import org.eco.collect.android.formentry.audit.IdentifyUserPromptDialogFragment;
import org.eco.collect.android.formentry.audit.IdentityPromptViewModel;
import org.eco.collect.android.formentry.backgroundlocation.BackgroundLocationHelper;
import org.eco.collect.android.formentry.backgroundlocation.BackgroundLocationManager;
import org.eco.collect.android.formentry.backgroundlocation.BackgroundLocationViewModel;
import org.eco.collect.android.formentry.repeats.AddRepeatDialog;
import org.eco.collect.android.fragments.MediaLoadingFragment;
import org.eco.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.eco.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import org.eco.collect.android.fragments.dialogs.NumberPickerDialog;
import org.eco.collect.android.fragments.dialogs.ProgressDialogFragment;
import org.eco.collect.android.fragments.dialogs.RankingWidgetDialog;
import org.eco.collect.android.listeners.AdvanceToNextListener;
import org.eco.collect.android.listeners.FormLoaderListener;
import org.eco.collect.android.listeners.PermissionListener;
import org.eco.collect.android.listeners.SavePointListener;
import org.eco.collect.android.listeners.WidgetValueChangedListener;
import org.eco.collect.android.location.client.GoogleLocationClient;
import org.eco.collect.android.logic.FormController;
import org.eco.collect.android.logic.FormController.FailedConstraint;
import org.eco.collect.android.logic.FormInfo;
import org.eco.collect.android.logic.ImmutableDisplayableQuestion;
import org.eco.collect.android.preferences.AdminKeys;
import org.eco.collect.android.preferences.AdminSharedPreferences;
import org.eco.collect.android.preferences.GeneralKeys;
import org.eco.collect.android.preferences.GeneralSharedPreferences;
import org.eco.collect.android.preferences.PreferencesActivity;
import org.eco.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.eco.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.eco.collect.android.storage.StorageInitializer;
import org.eco.collect.android.storage.StoragePathProvider;
import org.eco.collect.android.storage.StorageSubdirectory;
import org.eco.collect.android.tasks.FormLoaderTask;
import org.eco.collect.android.tasks.SaveFormIndexTask;
import org.eco.collect.android.tasks.SaveFormToDisk;
import org.eco.collect.android.tasks.SavePointTask;
import org.eco.collect.android.upload.AutoSendWorker;
import org.eco.collect.android.utilities.ApplicationConstants;
import org.eco.collect.android.utilities.DestroyableLifecyleOwner;
import org.eco.collect.android.utilities.DialogUtils;
import org.eco.collect.android.utilities.FileUtils;
import org.eco.collect.android.utilities.FormNameUtils;
import org.eco.collect.android.utilities.ImageConverter;
import org.eco.collect.android.utilities.MediaManager;
import org.eco.collect.android.utilities.MediaUtils;
import org.eco.collect.android.utilities.PermissionUtils;
import org.eco.collect.android.utilities.PlayServicesUtil;
import org.eco.collect.android.utilities.ScreenContext;
import org.eco.collect.android.utilities.SnackbarUtils;
import org.eco.collect.android.utilities.SoftKeyboardUtils;
import org.eco.collect.android.utilities.ToastUtils;
import org.eco.collect.android.widgets.DateTimeWidget;
import org.eco.collect.android.widgets.QuestionWidget;
import org.eco.collect.android.widgets.RangeWidget;
import org.eco.collect.android.widgets.StringWidget;
...
import static org.eco.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.eco.collect.android.preferences.GeneralKeys.KEY_BACKGROUND_LOCATION;
import static org.eco.collect.android.utilities.AnimationUtils.areAnimationsEnabled;
import static org.eco.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.eco.collect.android.utilities.PermissionUtils.areStoragePermissionsGranted;
import static org.eco.collect.android.utilities.PermissionUtils.finishAllActivities;
import static org.eco.collect.android.utilities.ToastUtils.showLongToast;
import static org.eco.collect.android.utilities.ToastUtils.showShortToast;
